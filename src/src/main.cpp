...
void outtakeCommand(int time, int speed){
    intake.spin(vex::directionType::fwd, speed, vex::velocityUnits::pct);
    wait(time, sec); 
    intake.stop(); 
}

void autoHomeGoalAndElevation(){
  moveCommand(36, 75); 
  turnCommand(90, 50);
  moveCommand(6, 50);
  outtakeCommand(2, 100); 
  moveCommand(6, 50); 
  moveCommand(-12, 100); 
  turnCommand(-90, 50); 
  moveCommand(-36, 75); 
...
void autoHomeGoalAndNoElevation(){
  moveCommand(36, 75); 
  turnCommand(90, 50);
  moveCommand(6, 50);
  outtakeCommand(2, 100); 
...
void autoOppositeGoalAndElevation(){
  turnCommand(-35, 50);
  moveCommand(36, 75); 
  outtakeCommand(2, 100); 
  moveCommand(-40, 75); 
...
void autoOppositeGoalAndENolevation(){
  turnCommand(-35, 50);
  moveCommand(36, 75); 
  outtakeCommand(2, 100); 
  moveCommand(-25, 75);
...
void autonomous(void) {
  ...
  // autoHomeGoalAndElevation();
  // autoOppositeGoalAndElevation(); 
  // autoHomeGoalAndNoElevation(); 
  // autoOppositeGoalAndENolevation(); 
}
